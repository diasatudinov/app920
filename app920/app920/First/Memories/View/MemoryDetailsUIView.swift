...
struct MemoryDetailsUIView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                ScrollView {
                    ForEach(attraction.memories, id: \.self) { memory in
                        
                        NavigationLink {
                            EditMemoryUIView(viewModel: viewModel, attraction: attraction, memory: memory)
                        } label: {
                ...
                HStack(spacing: 12) {
                    ...
                    NavigationLink {
                        AddMemoryUIView(viewModel: viewModel, attraction: attraction)
                    } label: {
                        ZStack {
                            Rectangle()
                                .frame(height: 50)
